 ...
 * withdrawals, and transfers between accounts. All successful transactions
 * are published as events to Kafka for downstream processing.
 */
@Service
...
public class TransactionService {
    ...
    public TransactionResponse deposit(DepositRequest request) {
        ...
        eventPublisher.publishTransactionEvent(transaction, account.getCustomer().getId());
    ...
    public TransactionResponse transfer(TransferRequest request) {
        ...
        eventPublisher.publishTransactionEvent(transferOut, fromAccount.getCustomer().getId());
        eventPublisher.publishTransactionEvent(transferIn, toAccount.getCustomer().getId());
